...
CREATE TABLE MEMBER (
    MEM_CODE NUMBER                 NOT NULL,
    MEM_NAME VARCHAR2(2000)         NULL,
    MEM_EMAIL VARCHAR2(2000)        NULL,
    MEM_PASSWORD VARCHAR2(2000)     NULL,
    MEM_GENDER VARCHAR2(10)         NULL,
    MEM_TYPE VARCHAR2(20)           NULL,
    MEM_TICKET NUMBER               DEFAULT 5 NOT NULL,
    MEM_IS_DELETED NUMBER           DEFAULT 0 NULL
    -- 가상 외래키
);
...
CREATE TABLE QUESTION (
    ...
    QUE_PATTERN	VARCHAR2(50)		NULL,
    QUE_TYPE	VARCHAR2(50)		NULL,
    QUE_LEVEL	VARCHAR2(50)		NULL,
    QUE_CREATED_AT DATE             NULL,
    QUE_MODIFIED_AT DATE            NULL,
    QUE_IS_DELETED NUMBER           DEFAULT 0 NULL,
    -- 가상 외래키
...
CREATE TABLE PASSAGE (
    ...
    PAS_FAVORITE	NUMBER	        DEFAULT 0 NULL,
    PAS_CREATED_AT DATE             NULL,
    PAS_MODIFIED_AT DATE            NULL,
    PAS_IS_DELETED NUMBER           DEFAULT 0 NULL,
    -- 가상 외래키
...
CREATE TABLE TICKET (
    TIC_CODE	NUMBER		        NOT NULL,
    TIC_NUMBER	NUMBER	            NULL,
    TIC_PRICE	NUMBER	    	    NULL
);
