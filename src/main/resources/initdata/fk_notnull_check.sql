...
-- -- NOT NULL
-- ALTER TABLE MEMBER
--     MODIFY (MEM_CODE NOT NULL, MEM_NAME NOT NULL, MEM_EMAIL NOT NULL,
--             MEM_PASSWORD NOT NULL, MEM_IS_DELETED NOT NULL);
--
-- ALTER TABLE NOTICE
--     MODIFY (NOT_CODE NOT NULL, NOT_TYPE NOT NULL, NOT_TITLE NOT NULL,
--             NOT_CONTENT NOT NULL, NOT_DATE NOT NULL);
--
-- ALTER TABLE PASSAGE
--     MODIFY (PAS_CODE NOT NULL, PAS_TITLE NOT NULL, PAS_CONTENT NOT NULL,
--             PAS_GIST NOT NULL, PAS_DATE NOT NULL, PAS_IS_FAVORITE NOT NULL,
--             PAS_IS_DELETED NOT NULL, PAS_IS_GENERATED NOT NULL, MEM_CODE NOT NULL);
--
-- ALTER TABLE PAYMENT
--     MODIFY (PAY_CODE NOT NULL, PAY_PRICE NOT NULL, PAY_DATE NOT NULL,
--             MEM_CODE NOT NULL, TIC_CODE NOT NULL);
--
-- ALTER TABLE QUESTION
--     MODIFY (QUE_CODE NOT NULL, QUE_QUERY NOT NULL, QUE_OPTION NOT NULL,
--     QUE_ANSWER NOT NULL, PAS_CODE NOT NULL);
--
-- ALTER TABLE TICKET
--     MODIFY (TIC_CODE NOT NULL, TIC_NUMBER NOT NULL, TIC_PRICE NOT NULL);
--
-- ALTER TABLE USAGE
--     MODIFY (USA_CODE NOT NULL, USA_TYPE NOT NULL, USA_DATE NOT NULL,
--             USA_COUNT NOT NULL, USA_BALANCE NOT NULL, MEM_CODE NOT NULL);
--
-- ---------------------------------------------------
--
-- -- CHECK
...
--
-- ALTER TABLE PASSAGE
--     ADD CONSTRAINT CHK_PAS_IS_GENERATED CHECK (PAS_IS_GENERATED IN (0, 1));
--
-- ALTER TABLE PASSAGE
--     ADD CONSTRAINT CHK_PAS_TYPE CHECK (PAS_TYPE IN ('기술', '문화', '사회', '예술', '인문', '과학'));
--
-- ALTER TABLE TICKET
